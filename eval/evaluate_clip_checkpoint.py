...
from train.train_cvs_clip_meanpool import ClipMeanPoolCVSModel


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a saved sparse-clip CVS checkpoint.")
    ...
    parser.add_argument("--target-position", choices=["end", "center"], default="end")
